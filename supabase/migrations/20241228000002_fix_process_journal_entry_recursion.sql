-- Fix the process_journal_entry function to remove recursive call
...
BEGIN
    ...
    -- REMOVED: Call to update_all_account_totals to prevent recursion
    -- The account totals are already updated above
